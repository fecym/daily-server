...
// consume表字段
export const consumeAmountField = ['repast_price', 'vehicle_price', 'drinks_price', 'snacks_price', 'transfer_accounts', 'life_price', 'cosmetic_price', 'other_price', 'total_amount', 'trip_price', 'shopping_price']
